...
// Brand canon (BRAND-DESIGN-SYSTEM §3.1): editorial serif headlines for
// academic integrity + institutional warmth, paired with Geist for body.
...
const style = {
  theme: "light", // dark | light | system — locked light to match the hardcoded warm palette
