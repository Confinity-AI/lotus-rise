...
interface BlobProps extends React.ComponentProps<typeof Row> {
  seed?: number;
}

export const Blob = ({ seed = 0, ...flex }: BlobProps) => {
  ...
  return (
    <Row fill pointerEvents="none" overflow="hidden" style={{ filter: "blur(2rem)" }} {...flex}>
      ...
      <Background
        ...
        style={{
          animation: `blob2 ${duration2}s ease-in-out infinite`,
        }}
      />
      ...
      <Background
        ...
        style={{
          animation: `blob3 ${duration3}s ease-in-out infinite`,
      ...
      <Background
        ...
        style={{
          animation: `blob1 ${duration1}s ease-in-out infinite`,
          mixBlendMode: "screen",
        }}
      />
